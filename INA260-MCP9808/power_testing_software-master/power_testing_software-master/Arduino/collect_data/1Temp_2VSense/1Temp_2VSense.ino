...
void setup() {
  ...
  if (!ina260_1.begin(0x40) || !tempsensor.begin(0x18) || !ina260_2.begin(0x41)) {
  ...
  ina260_2.setMode(INA260_MODE_CONTINUOUS);
...
void loop() {
    ...
    if (incomingByte == 'c') {
      ...
      current = ina260_2.readCurrent();     // mA
    ...
    if (incomingByte == 'v') {
      ...
      voltage = ina260_2.readBusVoltage();  // mV
